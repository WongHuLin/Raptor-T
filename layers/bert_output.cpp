...
void BertOutput::operator()(const torch::Tensor &hidden_states,
  ...
  //      "BertOutput/Reshape");
    ...
    reinterpret_cast<float*>(output_tensor.data_ptr()),reinterpret_cast<float*>(dense_bias_.data_ptr()),
    4096,2,768,float(1e-5),reinterpret_cast<float*>(layer_norm_weight_.data_ptr()),
