...
RUN  apt update \
    ...
    && tar -zxvf cmake-3.21.0-linux-x86_64.tar.gz -C  /usr/local/  \
    && ln -sf /usr/local/cmake-3.21.0-linux-x86_64/bin/* /usr/bin   \
    && rm cmake-3.21.0-linux-x86_64.tar.gz \
    && rm -rf /var/lib/apt/lists/* \ 
    && pip install packaging \
    && pip install einops==0.6.0 numpy==1.21.3 nvidia_ml_py3==7.352.0 setuptools==67.6.0 transformers==4.27.3